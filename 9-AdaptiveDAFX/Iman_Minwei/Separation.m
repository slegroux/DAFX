...
% wavwrite(myRecording,44100, 'beat.wav');
...
hlh =floor(lh/2)+1;
th =2500;
[DAFx_in, FS] =wavread('ex-harmonic2.wav');
DAFx_in = DAFx_in(:,1);
L =length(DAFx_in);
...
wavwrite(DAFx_out1, FS, 'ex-percussion3.wav');
wavwrite(DAFx_out2, FS, 'ex-harmonic3.wav');